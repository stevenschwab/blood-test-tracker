...
exports.up = async function(knex) {
  await knex.schema.dropTable('blood_test_results');
  await knex.schema.createTable('blood_test_results', blood_test_results => {
        ...
        blood_test_results.integer('biomarker_id')
            ...
            .onUpdate('RESTRICT')
            .onDelete('RESTRICT')
        blood_test_results.decimal('value', 10, 3)
